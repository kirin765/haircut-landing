...
export const metadata: Metadata = {
  ...
  title: {
    default: "노쇼 없는 미용실 | 미용실 예약 관리 프로그램",
    template: "%s | 노쇼 없는 미용실",
  },
  description:
    "미용실 예약 관리 프로그램. 헤어샵 노쇼 방지, 예약 리마인드, 시술시간 기록, 디자이너별 예약 간격 추천을 한 번에 제공합니다.",
  ...
  openGraph: {
    title: "노쇼 없는 미용실 | 미용실 예약 관리 프로그램",
    description:
      "기존 예약 시스템은 그대로 두고, 노쇼 방지와 디자이너별 시술시간 기록으로 예약 간격을 더 정확하게 맞추세요.",
  ...
  twitter: {
    ...
    title: "노쇼 없는 미용실 | 미용실 예약 관리 프로그램",
    description:
      "노쇼 방지와 시술시간 기록, 예약 간격 추천을 함께 제공하는 소규모 미용실용 운영 도구.",
    images: ["/og-image.png"],
  },
  other: {
